...
<%
	...
	for (CommentTO cto : cLists) {
		...
		strHtml.append("<a href='javascript:void(0)'; onclick=\"location.href='../comment/modify.do?cpage="+cpage+"&cseq="+Cseq+"&seq="+seq+"'\">수정</a>&nbsp;");
		strHtml.append("<a href='javascript:void(0)'; onclick=\"location.href='../comment/delete.do?cpage="+cpage+"&cseq="+Cseq+"&seq="+seq+"'\">삭제</a>&nbsp;");
		strHtml.append("</div>");
		strHtml.append("</div>");
		strHtml.append("</td>");
		strHtml.append("</tr>");
